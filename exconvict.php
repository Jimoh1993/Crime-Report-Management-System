	  ...
	  <div id="page-padding">
	    ...
	    <div id="content" style=" background:gainsboro; width:auto; margin-left:0px;">
	      <div id="content-padding" style="margin-left:0px;">
            ...
            <th>Date of Conviction</th><th>Cell No.</th><th>Court</th><th>Release Date</th><th>Inspector</th>
            <th>Age</th></tr>
            <?php
            $sql=mysql_query("SELECT * FROM criminals WHERE sta='nlk'");
